	...
	<div class="container bootcards-container" id="main">
		...
		<div class="row">
			<div class="bs-example bs-example-type">
				<h2>
					List of All Available Goals for Employee
				</h2>
				<div class="bootcards-list">
					<div class="panel panel-default">
							...
							<div class="list-group">
								<c:forEach items="${goals}" var="goal">
									<a class="list-group-item"
										href="/open-runnr/employee/viewgoal?goalid=${goal.id}">
										<div class="row">
											<div class="col-sm-6">
						...
						<c:if test="${empty goals}">
							...
							<h3>No Goal is available now... Please wait for your Manager
								to create new goal. Come back later !</h3>
