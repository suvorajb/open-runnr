...
<body>
	...
	<div class="row">
		<div class="bs-example bs-example-type">
			<h2>List of Goals Submitted for review </h2>
			<div class="bootcards-list">
			  <div class="panel panel-default">
				
				<c:if test="${not empty submttdgoals}">
					<div class="list-group">
						
						<c:forEach items="${submttdgoals}" var="goal">
							
							<a class="list-group-item" href="/open-runnr/review/submittdgoal?goalid=${goal.id}">
								<div class="row">
									  ...
									  <div class="col-sm-12">
										<h4 class="list-group-item-heading">Submitted By ${goial.empl_name} (${goal.empl_email})</h4>
										<p class="list-group-item-text"><b>Goal Start Date: </b> ${goal.empl_goal_start_date}</p>
										<p class="list-group-item-text"><b>Goal End Date: </b> ${goal.empl_goal_end_date}</p>
									  </div>
